    ...
    return (
            <header className="bg-[#ff5200] font-serif pb-5">
                ...
                <nav>
                    <div className="flex justify-between items-center w-[80%] mx-auto py-8">
                        ...
                        <div className="flex items-center gap-8 text-white font-bold">
                            ...
                            <Link to="/comingsoon" target="_blank">Partner with us</Link>
                            <Link to="/comingsoon" target="_blank" className="px-4 py-3 border border-white rounded-2xl">Get the App</Link>
                            <Link to="/comingsoon" target="_blank" className="px-4 py-3 border border-black rounded-2xl bg-black text-white">Sign in</Link>
                        </div>
                    </div>  
                </nav>
                ...
                <div className="w-[80%] mx-auto pb-2 py-5 flex ">
                    <Link to='/restaurant' target="_blank"><img src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/MERCHANDISING_BANNERS/IMAGES/MERCH/2024/7/23/ec86a309-9b06-48e2-9adc-35753f06bc0a_Food3BU.png" /></Link>
                    <Link to="/comingsoon" target="_blank"><img src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/MERCHANDISING_BANNERS/IMAGES/MERCH/2024/7/23/b5c57bbf-df54-4dad-95d1-62e3a7a8424d_IM3BU.png" /></Link>
                    <Link to="/comingsoon" target="_blank"><img src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/MERCHANDISING_BANNERS/IMAGES/MERCH/2024/7/23/b6d9b7ab-91c7-4f72-9bf2-fcd4ceec3537_DO3BU.png" /></Link>
                </div>
